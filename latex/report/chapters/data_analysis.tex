...
In the final training data set we chose to remove outliers greater than \( 10\sigma \) from the mean, which resulted in only removing the day corresponding to Brexit.
\begin{figure}[!htb]
    \begin{center}
