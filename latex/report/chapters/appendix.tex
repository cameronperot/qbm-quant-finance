...
The sign of the correlation coefficient determines whether it is negatively or positively correlated, and the magnitude determines how strong the correlation effects are.
