...
We used the results of this model as a baseline to compare the models trained using the annealer in the next subsection with.
...
The KL divergences in~\cref{fig:train_results_annealer} and~\cref{tbl:12_qubit_qbm_KL_divergences} show the model trained using the annealer was able to learn the training distribution to some extent, but still underperformed when compared with the simulation and the classically trained RBM.
