...
In~\cref{fig:rbm_autocorrelation_functions} we plotted the autocorrelation functions for the various models and currency pairs.
...
\begin{figure}[!htb]
    ...
    \end{center}
    \caption{Autocorrelation functions of the RBM models. Function values were computed from Gibbs sample chains of length \( 10^8 \).}
...
\begin{table}[!htb]
    ...
    \end{adjustbox}
    \caption{Correlation coefficients of the data set vs. samples generated by the RBM models. The RBM values are shown in the format mean \(\pm\) one standard deviation from an ensemble of 100 sample sets with \( 10^4 \) samples each.}
...
\begin{table}[!htb]
    ...
    \end{adjustbox}
    \caption{Historical volatilities of the data set vs. samples generated by the RBM models. The RBM values are shown in the format mean \(\pm\) one standard deviation from an ensemble of 100 sample sets with \( 10^4 \) samples each.}
...
\begin{table}[!htb]
    ...
    \end{adjustbox}
    \caption{Lower and upper tails, i.e., 1st and 99th percentiles, of the data set vs. samples generated by the RBM models. The RBM values are shown in the format mean \(\pm\) one standard deviation from an ensemble of 100 sample sets with \( 10^4 \) samples each.}
    \label{tbl:rbm_tails}
\end{table}
...
\begin{figure}[!htb]
    ...
    \end{center}
    \caption{Tail concentration functions of the data set vs. samples generated by the RBM models for every combination of the currency pairs.}
...
\begin{table}[!htb]
    ...
    \end{adjustbox}
    \caption{Conditional historical volatilities of the data set vs. samples generated by the RBM models. The RBM values are shown in the format mean \(\pm\) one standard deviation from an ensemble of 100 sample sets with \( 10^4 \) samples each.}
